...
const Navbar = () => {
    ...
    <h1 className=' text-lg font-burtons'>Portfolio</h1>
        ...
        <ul className=' flex items-center'>
            <li className=' ml-6 mr-6  hover:text-[#54d5bb]'><a href="#about">About Me</a></li>
            <li className=' ml-6 mr-6 hover:text-[#54d5bb]'><a href="#experience">Experience</a></li>
            <li className=' ml-6 mr-6 hover:text-[#54d5bb]'><a href="#projects">Projects</a></li>
            <li className=' ml-6 mr-6 hover:text-[#54d5bb]'><a href="#contact">Contact</a></li>
